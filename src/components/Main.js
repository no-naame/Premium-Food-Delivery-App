...
const Main = () => {
    ...
    const fetchData = async ()=>{
        const data = await fetch("https://thingproxy.freeboard.io/fetch/https://www.swiggy.com/dapi/restaurants/list/v5?lat=28.6333324&lng=77.0874664&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING");
